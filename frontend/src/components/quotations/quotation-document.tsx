                    ...
                    {expandedItems.has(item.id) && item.serviceRequirements?.teamRoster && item.serviceRequirements.teamRoster.length > 0 && (
                      <div className="mt-3 ml-0 md:ml-8 pt-3 border-t border-gray-200">
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
                          ...
                          {/* Team Notes under Team Roster */}
                          {item.notes && typeof item.notes === 'object' && item.notes.teamRosterNotes && (
                            <div className="mt-4 pt-4 border-t border-green-300">
                              <p className="text-xs font-semibold text-green-700 uppercase mb-2">Jersey Customization Notes (Optional)</p>
                              <div className="p-3 bg-green-50 border border-green-200 rounded text-sm text-gray-800">
                                {item.notes.teamRosterNotes}
                              </div>
                            </div>
                          )}
                        </div>
