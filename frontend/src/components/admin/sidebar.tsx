...
import { LayoutDashboard, Package, Briefcase, ShoppingCart, Layers, Users, Settings, X, ChevronRight, MapPin, Lock } from 'lucide-react'
...
export function AdminSidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-neutral-900 to-neutral-950 text-white transform transition-all duration-300 ease-in-out flex flex-col ${
          isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
        }`}
      >
        {/* Header */}
        <div className="h-20 flex items-center justify-between px-6 border-b border-red-600/30 bg-gradient-to-r from-red-600/10 to-orange-600/10">
