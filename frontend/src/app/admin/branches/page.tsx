    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-auto p-6">
          ...
          <p className="text-neutral-600">Manage business branches and centralized operations</p>
          <div className="mt-8 bg-white rounded-xl p-12 text-center">
            <p className="text-neutral-600">Multi-branch management system ready for implementation</p>
          </div>
        </main>
      </div>
    </div>
